...
test_that("add_lhc_and_robustness_sim_results_from_csv_file", {
  ...
  expect_message(add_lhc_and_robustness_sim_results_from_csv_file(dblink, "/home/kja505/Downloads/Spartan_Tutorial_Data/LHC_Spartan2/LHC_AllResults.csv", parameters, measures, "LHC", experiment_id),"147507 added to results database")
