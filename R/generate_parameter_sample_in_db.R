...
#' Return a generated sample from the database as an R object
#'
#' @param dblink A link to the database in which this entry is being added
#' @param experiment_id Id of the experiment in the database
#' @param experiment_date Date the experiment was performed
...
#'
#' @export
return_parameter_set<-function(dblink, experiment_id=NULL, experiment_description=NULL, experiment_date=NULL)
{
  tryCatch({
  ...
  {
    message(paste("Error in querying for parameter set in DB. Error message generated:\n",e,sep=""))
  })
}
