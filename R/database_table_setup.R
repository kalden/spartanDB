  ...
  tryCatch( {
    ...
    query<-paste("CREATE TABLE spartan_generated_stats (
      stat_id INT NOT NULL AUTO_INCREMENT,
                  ...
                  statistic_1 VARCHAR(240) NOT NULL,
                  statistic_2 VARCHAR(240),
                  statistic_3 VARCHAR(240),
                  statistic_4 VARCHAR(240),
                  statistic_5 VARCHAR(240),
                  statistic_6 VARCHAR(240),
                  statistic_7 VARCHAR(240),
                  statistic_8 VARCHAR(240),
                  statistic_9 VARCHAR(240),
      experiment_set_id INT NOT NULL,
